...
fs = moments.Spectrum.from_file("/home/ddayan/fundulus/moments_data/SFS/fs_no_adm.fs")
...
Optimize_Functions.Optimize_Routine(fs, prefix, run, demo_model, rounds, 6, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu1, nu2, m12, m21, T1, T2, P , p_misid", in_upper=upper, in_lower=lower)
