...
def demo_model(params, ns):
    ...
    """
    nuA, nu1, nu2, m12, m21, m12i, m21i, T, s , P = params
   ...
   #selection
    ...
    fsi.integrate(nu_func, T, m=asym_mig_i, dt_fac=0.01)
...
upper=[20,20,20,20,20,20,20,20,1,1]
...
# optimize
Optimize_Functions.Optimize_Routine(fs, prefix, run, demo_model, rounds, 10, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, param_labels = "nuA, nu1, nu2, m12, m21, m12i, m21i, T, s , P", in_upper=upper, in_lower=lower)
