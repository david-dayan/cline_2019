...
def demo_model(params, ns):
    ...
    fs.integrate([nu1_0, nu2_0], T1, m=nomig, dt_fac=0.01)
    fs.integrate(nu_func, T2, m=asym_mig, dt_fac=0.01)
    ...
    nomig = numpy.array([[0,0], [0,0]])
    fsi.integrate([nu1_0, nu2_0], T1, m=nomig, dt_fac=0.01)
    fsi.integrate(nu_func, T2, m=asym_mig_i, dt_fac=0.01)
