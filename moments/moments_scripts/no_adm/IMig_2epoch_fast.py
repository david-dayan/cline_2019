...
def demo_model(params, ns):
    ...
    """
    nu1_0, nu1, nu2_0, nu2, m12, m21, m12i, m21i, am12, am21, T1, T2, P = params
    ...
    asym_mig_2 = numpy.array([[0,m12], [m21,0]])
    asym_mig_1 = numpy.array([[0,am12], [am21,0]])
    fs.integrate(nu_func, T1, m=asym_mig_1, dt_fac=0.01)
    fs.integrate([nu1,nu2], T2, m=asym_mig_2, dt_fac=0.01)
...
upper=[20,20,20,20,20,20,20,20,20,20,20,20,1]
lower=[0.001, 0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001]
...
# optimize
Optimize_Functions.Optimize_Routine(fs, prefix, run, demo_model, rounds, 13, fs_folded=fs_folded,
