...
def parse_params(param_number, in_params=None, in_upper=None, in_lower=None):
    ...
    if fixed_params is None:
      fixed_params = [None] * param_number
    elif len(fixed_params) != param_number:
      raise ValueError("Set of input parameters does not contain the correct number of values: {}".format(param_number))
    else:
    ...
    return params, upper_bound, lower_bound, fixed_params
...
def Optimize_Routine(fs, outfile, model_name, func, rounds, param_number, fs_folded=True, fixed_params=None,
    ...
    params, upper_bound, lower_bound, fixed_params = parse_params(param_number, in_params, in_upper, in_lower, fixed_params)
    ...
    for r in range(rounds):
        ...
        for rep in range(1, (reps_list[r]+1) ):
            ...
            params_opt = moments.Inference.optimize_log(params_perturbed, fs, func,
                                                                 lower_bound=lower_bound, upper_bound=upper_bound, fixed_params=fixed_params,
