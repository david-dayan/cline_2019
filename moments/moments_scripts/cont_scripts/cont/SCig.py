...
upper=[20,20,20,20,20,20,20,20,20,20,1,1]
lower=[0.001, 0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.0001]
...
maxiters = [2000]
folds = [1]
params = [4.6791,1.6577,0.1389,10.5758,0.5446,0.0868,6.1374,0.4736,0.764,11.0122,0.1733,0.0037]

# optimize
Optimize_Functions.Optimize_Routine(fs, prefix, run, demo_model, rounds, 12, fs_folded=fs_folded,
