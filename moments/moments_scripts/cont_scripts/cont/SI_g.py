...
maxiters = [2000]
folds = [1]
params = [0.0382,1.6119,0.8003,0.933,0.0266,0.0001]

# optimize
Optimize_Functions.Optimize_Routine(fs, prefix, run, demo_model, rounds, 6, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, in_params=params,param_labels = "nu1, nu2, m, mi, T1, T2, P", in_upper=upper, in_lower=lower)
