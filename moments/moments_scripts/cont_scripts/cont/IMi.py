...
upper=[20,20,20,20,20,20,20,1,1]
lower=[0.001, 0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.0001]
...
maxiters = [2000]
folds = [1]
params = [0.8653,5.938,5.9689,0.8599,0.1159,9.9094,2.0183,0.2582,0.0035]

# optimize
Optimize_Functions.Optimize_Routine(fs, prefix, run, demo_model, rounds, 9, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, in_params=params, param_labels = "nu1,nu2,T,m12,m21,m12i,m21i,P,p_misid", in_upper=upper, in_lower=lower)
