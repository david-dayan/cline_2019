...
maxiters = [200]
folds = [1]
params = [0.7133,4.3893,1.6767,0.2725,3.9484]


# optimize
Optimize_Functions.Optimize_Routine(fs, prefix, run, demo_model, rounds, 5, fs_folded=fs_folded,
                                        reps=reps, maxiters=maxiters, folds=folds, in_params=params, param_labels = "nu1, nu2, m12, m21, T", in_upper=upper, in_lower=lower)
